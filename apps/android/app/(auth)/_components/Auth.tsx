  ...
  return (
    <View
      style={[
        ...
        { outlineWidth: focus ? 1.5 : 0, outlineOffset: 2 },
      ]}
    >
      <TextInput
  ...
  return (
    <View style={styles.main}>
      <View style={styles.formContainer}>
        <InputField value={authData} type="Email" setAuthData={setAuthData} />

        <View
          style={[
            inputStyle.inputContainer,
            { outlineWidth: true ? 1.5 : 0, outlineOffset: 2 },
          ]}
        >
          <TextInput
      ...
      >
        <Text style={styles.btnText}>
          {isProcessing ? <ActivityIndicator size={24} /> : btnTitle}
        </Text>
      </TouchableOpacity>
    </View>
  );
