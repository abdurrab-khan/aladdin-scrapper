...
import { deleteProductImage, updateProduct, uploadProductImage } from '@/lib/actions/product'
import { shareProduct } from '@/lib/actions/share-product'
import { CaptionDetails } from '@/lib/zod'
